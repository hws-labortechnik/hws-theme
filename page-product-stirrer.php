...
>
  <div class="w-full justify-start items-center grid grid-cols-12 gap-24 p-12  bg-[#EAEBEB]">
...
<?php 
$page_header_text_2 = get_field('page_header_text_2');
$page_header_title_2 = get_field('page_header_title_2');
if ($page_header_text_2 || $page_header_title_2) : ?>
<div id="SecondaryHeader" class="w-full h-auto justify-between items-end inline-flex">
    <div class="px-4 md:px-14 py-12 flex-col justify-start items-start gap-3.5 inline-flex">
      <div class="w-full text-neutral-600 text-sm font-normal font-['Roboto'] leading-tight"><?php echo $page_header_text_2; ?></div>
      <div class="w-full  text-black text-3xl font-light font-['Roboto'] leading-10"><?php echo $page_header_title_2; ?></div>
    </div>
</div>
<?php endif; ?>
...
<?php while( have_rows('bottom_banner') ): the_row(); 
  ...
  $datasheet = get_sub_field('datasheet');
?>
<div
data-aos="fade-in"
data-aos-offset="100"
...
>
  <div class="w-full justify-start items-center grid grid-cols-12 gap-24 p-12  bg-[#EAEBEB]">
      <div class="col-span-12 md:col-span-7 justify-center items-start gap-3.5">
        <div class="text-black text-4xl font-light font-['Roboto'] leading-10 pb-4"><?php the_sub_field('banner_title'); ?></div>
        <div class="text-black text-base font-light font-['Roboto'] leading-normal"><?php the_sub_field('banner_text'); ?></div>
      </div>
      <div class="col-span-12 md:col-span-5 justify-start items-center gap-8 inline-flex">
        <a href="/contact" class="group transition-all duration-1000 px-4 py-2 rounded-3xl border border-neutral-600 text-sm font-normal leading-tight flex justify-start items-center bg-[#000] hover:bg-[#4F4F4F] text-white">
          Contact us
        ...
        <a href="<?php the_sub_field('datasheet'); ?>" target="_blank" class=" text-black text-sm font-normal font-['Roboto'] leading-tight flex flex-inline items-center">
          Download PDF Datasheet
          <svg class="ml-2" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M14.4414 8.05867L9.67884 12.8212C9.09306 13.407 8.14331 13.407 7.55752 12.8212L2.79496 8.05867L3.50207 7.35156L8.26463 12.1141C8.45989 12.3094 8.77648 12.3094 8.97174 12.1141L13.7343 7.35156L14.4414 8.05867Z" fill="#030303"/>
          <path fill-rule="evenodd" clip-rule="evenodd" d="M8.11719 12.705L8.11719 0.260742L9.11719 0.260742L9.11719 12.705L8.11719 12.705Z" fill="#030303"/>
