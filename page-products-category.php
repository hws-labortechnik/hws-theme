...
class="mt-28 w-full h-auto pr-0 md:pr-16 justify-between items-end inline-flex">
    <div class="px-4 md:px-14 py-12 flex-col justify-start items-start gap-3.5 inline-flex">
      <div class="w-16 text-neutral-600 text-sm font-normal font-['Roboto'] leading-tight">Products</div>
      <div class="w-[100%] text-black text-3xl font-light font-['Roboto'] leading-10"><?php the_title(); ?></div>
    </div>
</div>
...
data-aos-duration="600"
data-aos-easing="ease-in-out"  
class="grid grid-cols-12 px-4 md:px-14 w-full gap-6">
  <div class="col-span-12 md:col-span-6 lg:col-span-4 max-h-min">
