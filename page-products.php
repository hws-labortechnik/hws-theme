...
class="mt-28 w-full h-auto pr-0 justify-between items-end inline-flex">
    <div class="px-4 md:px-14 py-12 flex-col justify-start items-start gap-3.5 inline-flex">
      <div class="w-16 text-neutral-600 text-sm font-normal font-['Roboto'] leading-tight"><?php the_title(); ?></div>
      <div class="text-black text-3xl font-light font-['Roboto'] leading-10"><?php the_content(); ?></div>
    </div>
</div>
