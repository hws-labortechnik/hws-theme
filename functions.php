...
function hws_enqueue_styles() {
    wp_enqueue_style('theme-style', get_stylesheet_uri());
}
add_action('wp_enqueue_scripts', 'hws_enqueue_styles');

function hws_enqueue_fancy_dropdown() {
    wp_enqueue_script(
        'fancy-dropdown',
        get_stylesheet_directory_uri() . '/public/js/fancy-dropdown.js',
        array('jquery'),
        '1.0',
        true
    );
}
add_action('wp_enqueue_scripts', 'hws_enqueue_fancy_dropdown');
...
// Add AJAX handler for the contact form v3
...
function handle_contact_form_v3() {
    try {
        ...
        // Send email using the process_contact_form function from inc/process-contact-form.php
...
function add_ajax_data() {
    wp_localize_script('fancy-dropdown', 'contactForm', array(
        'ajaxUrl' => admin_url('admin-ajax.php'),
        'nonce' => wp_create_nonce('contact_form_nonce'),
        'thankYouUrl' => home_url('/thank-you/') // Add the thank you page URL
    ));
}
                        ...
                        <div class="w-full h-auto">
                            <?php if ($url) : ?>
                                <a href="<?php echo esc_url($url); ?>">
                                    <?php
                                    // Get the cropped image URL using wp_get_attachment_image_src
