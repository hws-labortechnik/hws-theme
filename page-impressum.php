...
<div class="mt-28 w-full pr-16 justify-between items-end inline-flex">
    <div class="px-4 md:px-14 py-12 flex-col justify-start items-start gap-3.5 inline-flex">
      <div class="text-neutral-600 text-sm font-normal font-['Roboto'] leading-tight">Impressum & Data protection</div>
      <div class="max-w-[60%] text-black text-3xl font-light font-['Roboto'] leading-10"><?php the_title(); ?></div>
    </div>
</div>

<div class="mt-0 w-full mx-auto min-h-[680px] px-4 md:px-14 justify-start items-start gap-6 inline-flex">
    <div class="w-full min-h-full py-12 flex-col justify-start items-center gap-2.5 inline-flex bg-white rounded-lg">
        <div class="max-w-[876px] mx-auto mt-14">
            <?php the_content(); ?>
        </div>
    </div>
</div>
