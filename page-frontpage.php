...
<div class="animation-container w-full relative"> 
    ...
    id="first" class="z-10 px-4 md:px-14 py-6 md:py-0 max-w-[820px] flex items-end md:items-center justify-start text-[#020202] text-5xl md:text-6xl font-thin font-['Roboto'] leading-[45px] md:leading-[60px]">Unmatched Precision, Flexibility, and Adaptability in One Function-Oriented Solution</div>
    ...
    id="second" class="z-10 px-4 md:px-14 flex items-end md:items-center justify-start max-w-[720px]  text-[#020202] text-5xl md:text-6xl font-thin font-['Roboto'] leading-[60px]">
        <div class="">
        Stirrer Guide
        <p class="text-[#020202] text-xl font-thin font-['Roboto'] leading-[30px]">Innovative and proprietary design for precise stirring. High gas tightness, chemical and thermal resistance, as well as friction reduction through the use of high-quality material combinations.</p>
        </div>
    </div>
    <div id="third" class="z-10 px-4 md:px-14 flex items-end md:items-center justify-start max-w-[720px] text-[#020202] text-5xl md:text-6xl font-thin font-['Roboto'] leading-[60px]">
        <div class="">
        Glass Reactor
        <p class="text-[#020202] text-xl font-thin font-['Roboto'] leading-[30px]">Crafted from premium borosilicate glass for high transparency and temperature resistance. Modular design using the adapted HWS accessory range for seamless operation under extreme laboratory conditions.</p>
        </div>
    </div>
    <div id="fourth" class="z-10 px-4 md:px-14 flex items-end md:items-center justify-start max-w-[720px] text-[#020202] text-5xl md:text-6xl font-thin font-['Roboto'] leading-[60px]">
        <div class="">
        Bottom Outlet Valve
        <p class="text-[#020202] text-xl font-thin font-['Roboto'] leading-[30px]">Dead volume-free system, temperature-resistant, chemical-resistant, and self-adjusting for reliable sealing in the process area.</p>
        </div>
    </div>
</div>
