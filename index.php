  ...
  <?php display_products(); ?>
          ...
          <div class="relative  w-full bg-zinc-100/0 h-screen">
              ...
              <div class="absolute bottom-28 left-12 z-20 bg-white/50 backdrop-blur-md p-12 max-w-[440px] max-h-min rounded-md">
                  <h1 class="text-3xl font-light font-['Roboto'] py-3">Expertise</h1>
                  <p class="text-xl font-light font-['Roboto'] leading-8 pt-2 pb-4">The high quality is guaranteed by first-class raw materials, such as borosilicate glass from Schott, Mainz, passion and years of experience of our highly skilled masters and craftsmen in the workshop and a consistent quality assurance system.</p>
