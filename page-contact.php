...
<div class="grid grid-cols-12 gap-6 md:gap-14 px-4 md:px-14">
    <div class="col-span-12 md:col-span-6 pr-0 md:pr-20">
        ...
        <div class="mt-6 h-24 bg-zinc-100 justify-start items-start gap-12 inline-flex">
          <div class="w-28 flex-col justify-start items-start gap-3 inline-flex">
            <div class="text-center text-black text-sm font-light font-['Roboto'] leading-tight">Adress</div>
            <div class="self-stretch text-black text-base font-normal font-['Roboto'] leading-normal">HWS Mainz <br/>Saarstraße 52,    55122 Mainz</div>
          </div>
          <div class="flex-col justify-start items-start gap-3 inline-flex">
            <div class="text-center text-black text-sm font-light font-['Roboto'] leading-tight">E-mail</div>
            <div class="text-center text-black text-base font-normal font-['Roboto'] leading-normal">info@hws-mainz.de</div>
          </div>
          <div class="flex-col justify-start items-start gap-3 inline-flex">
            <div class="text-center text-black text-sm font-light font-['Roboto'] leading-tight">Telephone</div>
            <div class="text-center text-black text-base font-normal font-['Roboto'] leading-normal">06131374560</div>
          </div>
        </div>
    </div>
    <div
