...
<div class="grid grid-cols-12 md:gap-20 xl:gap-34 px-4 md:px-14 mb-16">
    <div class="col-span-12 md:col-span-6 mb-12 md:mb-0">
        ...
        <?php if( have_rows('hws_contact') ): ?>
            <?php while( have_rows('hws_contact') ): the_row(); 
            ...
            <div id="IntroBox" class="">
                ...
                <div class="grow shrink basis-0 flex-col justify-start items-start gap-6 inline-flex">
                    <div class="self-stretch text-[#020202] text-3xl font-light font-['Roboto'] leading-10"><?php echo acf_esc_html( get_sub_field('country') ); ?></div>
                    <div class="self-stretch justify-start items-start gap-6 inline-flex">
                      <div class="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                          ...
                          <div class="self-stretch text-[#020202] text-base font-light font-['Roboto'] leading-normal"><?php echo acf_esc_html( get_sub_field('company') ); ?><br/><?php echo acf_esc_html( get_sub_field('address') ); ?></div>
                      </div>
                      <div class="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                          <div class="self-stretch text-[#888888] text-base font-light font-['Roboto'] leading-normal">E-mail</div>
                          <div class="self-stretch text-[#020202] text-base font-light font-['Roboto'] leading-normal"><a href="mailto:<?php echo acf_esc_html( get_sub_field('email') ); ?>"><?php echo acf_esc_html( get_sub_field('email') ); ?></a></div>
                      </div>
                    </div>
                    <div class="self-stretch justify-start items-start gap-6 inline-flex">
                      <div class="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                          <div class="self-stretch text-[#888888] text-base font-light font-['Roboto'] leading-normal">Phone</div>
                          <div class="self-stretch text-[#020202] text-base font-light font-['Roboto'] leading-normal"><a href="tel:+<?php echo acf_esc_html( get_sub_field('phone') ); ?>"><?php echo acf_esc_html( get_sub_field('phone') ); ?></a></div>
                      </div>
                      <div class="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                          <div class="self-stretch text-[#888888] text-base font-light font-['Roboto'] leading-normal">Fax</div>
                          <div class="self-stretch text-[#020202] text-base font-light font-['Roboto'] leading-normal"><?php echo acf_esc_html( get_sub_field('fax') ); ?></div>
                      </div>
                    </div>
                    <div class="self-stretch justify-start items-start gap-6 inline-flex">
                      <div class="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                          <div class="self-stretch text-[#888888] text-base font-light font-['Roboto'] leading-normal">Website</div>
                          <div class="self-stretch text-[#020202] text-base font-light font-['Roboto'] leading-normal"><a href="https://<?php echo acf_esc_html( get_sub_field('web') ); ?>" target="_blank"><?php echo acf_esc_html( get_sub_field('web') ); ?></a></div>
                      </div>
                    </div>
                </div>
                </div>
        ...
        <?php if( have_rows('contact_item') ): ?>
            ...
            $web = get_sub_field('web');
            ?>
            <div id="<?php echo acf_esc_html( get_sub_field('id') ); ?>Box" class="hidden">
                <div class="min-h-max px-4 py-6 bg-[#eaebeb] rounded-lg justify-start items-start inline-flex">
                <div class="grow shrink basis-0 flex-col justify-start items-start gap-6 inline-flex">
                    <div class="self-stretch text-[#020202] text-3xl font-light font-['Roboto'] leading-10"><?php echo acf_esc_html( get_sub_field('country') ); ?></div>
                    <div class="self-stretch justify-start items-start gap-6 inline-flex">
        ...
        <div class="mb-12 relative">
            <div class="flex justify-between relative">
                <div class="z-40 step-indicator active" data-step="1">
                    <div class="mb-2 ml-12 w-3 h-3 bg-gray-200 rounded-full transition-all duration-300"></div>
                    ...
                    <div id="countryselection" class="custom-select">
                        ...
                        <select name="country" class="text-[#888888] w-full h-14 px-4 py-3 bg-[#F2F3F3] border border-[#888888] focus:outline-none focus:border-black/20 hidden">
                            ...
                            <?php if( have_rows('contact_item') ): ?>
                                ...
                                $company = get_sub_field('company');
                                ?>
                                    <option value="<?php echo acf_esc_html( get_sub_field('id') ); ?>"><?php echo acf_esc_html( get_sub_field('country') ); ?> - <?php echo acf_esc_html( get_sub_field('company') ); ?></option>
                                <?php endwhile; ?>
                            <?php endif; ?>
<!--
...
<div>
  <label class="block mb-2 text-xl font-light font-['Roboto'] leading-[30px]">Address</label>
  <input
  type="text"
  name="address"
  autocomplete="street-address"
  placeholder="Street, city, ZIP, country"
  class="bg-[#F2F3F3] w-full px-4 py-3 rounded-full border border-[#4f4f4f] focus:outline-none focus:border-black"
>
