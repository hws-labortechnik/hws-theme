...
$(document).ready(function() {
    $('#langSelect').click(function(e) {
        e.stopPropagation();
        $(this).toggleClass('bg-zinc-100 rounded-bl-none rounded-br-none bg-[#F2F3F3]/40 backdrop-blur-md bg-zinc-100 border-zinc-900');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function startAnimation() {
        const maxScroll = historySection.scrollWidth - historySection.clientWidth;
